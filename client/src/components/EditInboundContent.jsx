            ...
            <div className='addpurchase-content ml-64 px-8 mt-5'>
                ...
                <form class="max-w-sm"> 
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" placeholder="type in quantity" onChange={handleChange} name='supplier' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 "/>
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" placeholder="type in title" onChange={handleChange} name='date_received' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 "/>
                    </div>
                    {/* button */}
                    <button class="mr-2 text-white bg-red-700 hover:bg-red-800 rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"><Link to="/inbound">Cancel</Link></button>
